...
NRC: 2968  Carrera de Ingeniería de Software <br/>
7to ciclo  Docente: Marco Antonio Leon Baca <br/>
...
| - | - | - |
|Trabaja en equipo para proporcionar liderazgo en forma conjunta  |<p>**Harold Miguel Elías Sanchez** TB1: En el desarrollo de Strategic-Level Domain- Driven Design, lideré sesiones de EventStorming donde impulsé la identificación colaborativa de contextos candidatos y flujos de mensajes, promoviendo una participación activa y equitativa del equipo para consolidar decisiones clave del dominio. </p><p>**Victor Manuel Meneses Arevalo** </p><p>TB1:   </p><p>En el desarrollo del capítulo "Requirements Elicitation & Analysis", participé activamente en el análisis de competidores y en la elaboración de entrevistas, desde su diseño hasta su análisis. Contribuí a la creación de herramientas como User Personas, User Journey Mapping y Empathy Mapping, fomentando una comprensión profunda de las necesidades del usuario y fortaleciendo la base para una solución centrada en el usuario. </p><p>**Brayan Stiven Gamboa Delgado** </p>||


||<p>TB1:  </p><p>En el desarrollo del Software Architecture, contribuí a la creación del C4 Model para el Landscape, System Context, Containers y Deployment para un mayor entendimiento del sistema. </p><p>**Rodrigo Adrián López Huamán**  </p><p>TB1:   </p><p>En el desarrollo del Tactical- Level Domain-Driven Design, estructuré y documenté cinco Bounded Contexts, detallando sus respectivas capas: Domain, Interface, Application e Infrastructure. Además, elaboré diagramas de arquitectura a nivel de componentes y código, incluyendo diagramas de clases de la capa de dominio y diseños de base de datos para cada contexto, garantizando una visión clara y coherente del sistema a nivel táctico. </p><p>**Rodrigo Jesús Salvador Rodríguez**  </p><p>TB1:  En el desarrollo de la Introduction, evidencié nuestra propuesta de trabajo en base a lo planteado durante las sesiones con descripción de la startup, Lean UX, Solution Profile y Segmentos objetivos, además en los Requeriments Specifications, evidenciar de buena manera los Scenario </p>||
| :- | - | :- |


||Mapping, las User Stories con el formato adecuado y el Product Backlog. ||
| :- | :- | :- |
|Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos. |<p>**Harold Miguel Elías Sanchez** TB1:  </p><p>Fomenté un ambiente inclusivo guiando al equipo en la creación de Bounded Context Canvases y mapas de contexto, estableciendo metas claras y asignando tareas estratégicas que facilitaron el cumplimiento de los objetivos definidos de manera eficiente y coordinada.   </p><p>**Brayan Stiven Gamboa Delgado** </p><p>TB1:  </p><p>Planifiqué un entorno de trabajo colaborativo estableciendo objetivos con duración para la entrega del informe y creación del C4 Model para que sea más estructurado. </p><p>**Victor Manuel Meneses Arevalo** </p><p>TB1:   </p>||


||<p>Promovì un trabajo colaborativo liderando la planificación y ejecución de actividades clave del análisis de requerimientos, como entrevistas, mapas de empatía y User Personas. Establecí objetivos claros y coordiné la distribución de tareas estratégicas, asegurando una recolección efectiva de información que permitió al equipo comprender a fondo al usuario y al entorno competitivo. </p><p>**Rodrigo Adrián López Huamán**  </p><p>TB1:  </p><p>` `Fomenté un entorno colaborativo e inclusivo al coordinar al equipo en la elaboración de los cinco Bounded Contexts dentro de la sección 4.2 del Tactical-Level Domain-Driven Design. Establecí metas claras y planifiqué tareas para el desarrollo estructurado de las capas Domain, Interface, Application e Infrastructure, así como la construcción de los respectivos diagramas de arquitectura a nivel de componentes, código, clases de dominio y diseño de base de datos, cumpliendo los objetivos técnicos de forma eficiente y organizada. </p>||
| :- | :- | :- |


||<p>**Rodrigo Jesús Salvador Rodríguez**  </p><p>TB1: Planifiqué un entorno colaborativo e inclusivo en el aporte del trabajo, evidenciando mi responsabilidad al desarrollar la Startup Profile, Solution Profile, Segmentos Objetivos, y el desarrollo de los Requeriments Specification. </p>||
| :- | :- | :- |
